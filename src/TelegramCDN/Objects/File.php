<?php
    ...
    class File
    {
        ...
        {
            return ["file_id" => $this->FileID, "file_unique_id" => $this->FileUniqueID, "mime_type" => $this->MimeType, "original_file_size" => $this->OriginalFileSize, "original_file_hash" => $this->OriginalFileHash];
        }
        /**
